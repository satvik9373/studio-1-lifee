function UET(o) {
    ...
    this._push = function(n) {
        ...
        if (n[1] instanceof Array)
            ...
            for (f in n[1][0]) this.knownParams.hasOwnProperty(f) && (this.pageLevelParams[f] = n[1][0][f])
        } else if (n[0] === "consent") {
            if (this.uetConfig.consent.enabled = !0, t = n[1][1], u = n[1][0], t === null || typeof t != "object") return;
            u === "default" ? (t.hasOwnProperty("ad_storage") && this.uetConfig.consent.adStorageUpdated === !1 && (this.uetConfig.consent.adStorageAllowed = t.ad_storage !== "denied"), t.hasOwnProperty("wait_for_update") && (i = parseInt(t.wait_for_update, 10), !isNaN(i) && i > 0 && (i = Math.min(i, 1e4), this.uetConfig.consent.waitForUpdate = i))) : u === "update" && t.hasOwnProperty("ad_storage") && (this.uetConfig.consent.adStorageAllowed = t.ad_storage !== "denied", this.uetConfig.consent.adStorageUpdated = !0, this.uetConfig.consent.adStorageAllowed ? this.pageLoadDispatch && this.addMsClkId(this.beaconParams) : (delete this.beaconParams.sid, delete this.beaconParams.vid, delete this.beaconParams.msclkid))
        } else if (n[0] === "config") {
            if (t = n[1][1], u = n[1][0], t === null || typeof t != "object") return;
            u === "tcf" && t.hasOwnProperty("enabled") && t.enabled === !0 && typeof __tcfapi == "function" && (this.uetConfig.tcf.enabled = !0, window.__tcfapi("addEventListener", 2, this.tcfCallback.bind(this)))
        }
    };
